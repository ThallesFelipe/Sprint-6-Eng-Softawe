...
{
public:
	FlowExponentialImplementation(string id = "", System *source = nullptr, System *destiny = nullptr) : FlowImplementation(id, source, destiny) {};
	/**
...
/**
 * @brief FlowLogisticImplementation: Class that implementes the execute function of the Logistic flow
 * 
 */
class FlowLogisticImplementation : public FlowImplementation
{
public:
	FlowLogisticImplementation(string id = "", System *source = nullptr, System *destiny = nullptr) : FlowImplementation(id, source, destiny) {};
...
/**
 * @brief ComplexFlow: Class that implementes the execute function of the Complex flow
 *
 */
class ComplexFlow : public FlowImplementation
{
public:
	ComplexFlow(string id = "", System *source = nullptr, System *destiny = nullptr) : FlowImplementation(id, source, destiny) {};
...
void logisticalFunctionalTest()
{
	...
	modelLogistic->setId("Logistic Model");
