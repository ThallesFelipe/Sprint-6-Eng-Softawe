...
{
public:
    TestFlow(string id = "", System *source = nullptr, System *destiny = nullptr) : FlowImplementation(id, source, destiny) {};
...
void unit_model_clear()
{
    ...
    Flow *flowExp1 = new FlowHandle<FlowExponentialImplementation>("flowExp", system1, system2);
